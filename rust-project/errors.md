...
Error Handling
// Rust doesn’t have exceptions, instead it has the value Result<T, E> for
// recoverable errors and the panic! macro for unrecoverable.

Unrecoverable Errors with panic!

When panic! macro executes, program will print a failure message, unwind and
clean up the stack, and then quit.
To abort on panic instead of unwind=>clean=>quit, add
panic = 'abort' to the [profile] Cargo.toml.
